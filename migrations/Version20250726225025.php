 ...
 */
final class Version20250726225025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subcategory ADD CONSTRAINT FK_DDCA4484584665A FOREIGN KEY (product_id) REFERENCES product (id)');
